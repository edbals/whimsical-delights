...
export default function StepFlavour() {
  ...
  return (
    <div className="space-y-4">
      <div>
        <h2 className="font-serif text-2xl text-ink">Choose your flavour</h2>
        ...
        {flavours.map((f) => {
          ...
          return (
            <motion.button
              ...
              className={cn(
                'flex items-center gap-2 px-4 py-2.5 rounded-full border-2 text-sm font-medium font-sans transition-all cursor-pointer',
                selected
            ...
            >
              <span
                className="w-3.5 h-3.5 rounded-full border border-ink/10 flex-shrink-0"
                style={{
